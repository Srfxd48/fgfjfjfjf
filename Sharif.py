        						...
        						for item in c:
        							if len(item) == 28 and "|" not in str(item)[0:14] and "|" not in str(item)[26:28] :
        								if item not in repeated:
        									...
        									if clord == 0:
        										clord = 1
        										print(clorr1 + str(cnter) + clorr2 + "|" + clorr1 + onichan + clorr2 + "|" + clorr1 + "X-Scrap v2.0" + clorr2 + "|" + clorr1 + "Srf_xd" + clorr2 + "|" + clorr1 + "Srf_xd" + clorr2 + "|" + clorr1 + "Srf_xd")
        									elif clord == 1:
        										clord = 0
        										print(clorr2 + str(cnter) + clorr1 + "|" + clorr1 + onichan + clorr2 + "|" + clorr2 + "X-Scrap v2.0" + clorr1 + "|" + clorr2 + "Srf_xd" + clorr1 + "|" + clorr2 + "Srf_xd" + clorr1 + "|" + clorr2 + "Srf_xd")
